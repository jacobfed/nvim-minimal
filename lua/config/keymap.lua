...
-- [[ Custom Keymaps]]
vim.keymap.set({ "n", "t", "v" }, "<leader>qq", ":qa<CR>:qa<CR>:qa<CR>", { desc = "Quit nvim" })
...
-- Keybinding to close terminal
vim.keymap.set("t", "<leader>ct", function()
	vim.cmd("close") -- Close the current terminal window
end)
